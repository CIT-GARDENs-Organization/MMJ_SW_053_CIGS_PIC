...
*/
// DATA ID for CIGS
#define DATA_ID_CIGS_PICLOG 0xA0
#define DATA_ID_CIGS_IV1_DATA 0xA1
#define DATA_ID_CIGS_IV2_DATA 0xA2
...
// FLASH SIZE for CIGS
#define SMF_PICLOG_SIZE     4096
#define SMF_IV1_DATA_SIZE    3579904
#define SMF_IV2_DATA_SIZE    3579904

#define SMF_PICLOG_HEADER_START_ADDRESS       0x05290000
#define SMF_PICLOG_HEADER_END_ADDRESS         SMF_PICLOG_HEADER_START_ADDRESS + SUBSECTOR_SIZE - 1
#define SMF_PICLOG_DATA_START_ADDRESS         SMF_PICLOG_HEADER_END_ADDRESS + 1
#define SMF_PICLOG_DATA_END_ADDRESS           SMF_PICLOG_DATA_START_ADDRESS + SMF_PICLOG_SIZE - 1

#define SMF_IV1_DATA_HEADER_START_ADDRESS     0x05292000
#define SMF_IV1_DATA_HEADER_END_ADDRESS       SMF_IV1_DATA_HEADER_START_ADDRESS + SUBSECTOR_SIZE - 1
#define SMF_IV1_DATA_DATA_START_ADDRESS       SMF_IV1_DATA_HEADER_END_ADDRESS + 1
#define SMF_IV1_DATA_DATA_END_ADDRESS         SMF_IV1_DATA_DATA_START_ADDRESS + SMF_IV1_DATA_SIZE - 1

#define SMF_IV2_DATA_HEADER_START_ADDRESS     0x055FD000
#define SMF_IV2_DATA_HEADER_END_ADDRESS       SMF_IV2_DATA_HEADER_START_ADDRESS + SUBSECTOR_SIZE - 1
#define SMF_IV2_DATA_DATA_START_ADDRESS       SMF_IV2_DATA_HEADER_END_ADDRESS + 1
#define SMF_IV2_DATA_DATA_END_ADDRESS         SMF_IV2_DATA_DATA_START_ADDRESS + SMF_IV2_DATA_SIZE - 1




/*
legacy memory map for CIGS
*/
...
#define _RESERVED_ADDRESS                     0x07D8A000
#define SMF_DATA_TABLE_HEADER_START_ADDRESS   _RESERVED_ADDRESS
#define SMF_DATA_TABLE_HEADER_END_ADDRESS     SMF_DATA_TABLE_HEADER_START_ADDRESS + SUBSECTOR_SIZE - 1
#define SMF_DATA_TABLE_DATA_START_ADDRESS     SMF_DATA_TABLE_HEADER_END_ADDRESS + 1
#define SMF_DATA_TABLE_DATA_END_ADDRESS       SMF_DATA_TABLE_DATA_START_ADDRESS + SUBSECTOR_SIZE - 1

#define SMF_ENVIRO_HEADER_START_ADDRESS       SMF_DATA_TABLE_DATA_END_ADDRESS + 1
#define SMF_ENVIRO_HEADER_END_ADDRESS         SMF_ENVIRO_HEADER_START_ADDRESS + SUBSECTOR_SIZE - 1
#define SMF_ENVIRO_DATA_START_ADDRESS         SMF_ENVIRO_HEADER_END_ADDRESS + 1
#define SMF_ENVIRO_DATA_END_ADDRESS           SMF_ENVIRO_DATA_START_ADDRESS + SUBSECTOR_SIZE - 1

#define SMF_IV1_HEADER_HEADER_START_ADDRESS   SMF_ENVIRO_DATA_END_ADDRESS + 1
#define SMF_IV1_HEADER_HEADER_END_ADDRESS     SMF_IV1_HEADER_HEADER_START_ADDRESS + SUBSECTOR_SIZE - 1
#define SMF_IV1_HEADER_DATA_START_ADDRESS     SMF_IV1_HEADER_HEADER_END_ADDRESS + 1
#define SMF_IV1_HEADER_DATA_END_ADDRESS       SMF_IV1_HEADER_DATA_START_ADDRESS + SUBSECTOR_SIZE - 1

#define SMF_IV2_HEADER_HEADER_START_ADDRESS   SMF_IV1_HEADER_DATA_END_ADDRESS + 1
#define SMF_IV2_HEADER_HEADER_END_ADDRESS     SMF_IV2_HEADER_HEADER_START_ADDRESS + SUBSECTOR_SIZE - 1
#define SMF_IV2_HEADER_DATA_START_ADDRESS     SMF_IV2_HEADER_HEADER_END_ADDRESS + 1
#define SMF_IV2_HEADER_DATA_END_ADDRESS       SMF_IV2_HEADER_DATA_START_ADDRESS + SUBSECTOR_SIZE - 1
